        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item <?php if ($menu_active == 'about'){ echo 'active';} ?>">
                    <a class="nav-link" href="<?php echo base_url('bootsrap/about');?>">About</a>
                </li>
                <li class="nav-item <?php if ($menu_active == 'contact'){ echo 'active';} ?>">
                    <a class="nav-link" href="<?php echo base_url('bootsrap/contact');?>">Contact</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <div id="body">
                ...
                <code>application/views/v_bootstrap.php</code>
